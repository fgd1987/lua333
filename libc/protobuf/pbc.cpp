...
static int MapPath(lua_State* L)
{
    if(lua_isstring(L, 1) && lua_isstring(L, 2)){
        ...
        const char *dest_dir = lua_tostring(L, 2);
        sourceTree->MapPath(token, dest_dir);
        sourceTree->MapPath(token, dest_dir);
        return 1;
    }
    return 0;
...
static int msg_parse_from_string(lua_State *L){
...
static int msg_is_dirty(lua_State *L){
...
//将message转为lua table
static void pb_load_tree(const google::protobuf::Message *message, lua_State* L, int deep){
    lua_newtable(L);
        ...
        if(field->is_repeated()){
            ...
            for(int i = 0; i < size; i++){
                    if(field->type() == google::protobuf::FieldDescriptor::TYPE_MESSAGE){
                        ...
                        pb_load_tree(&field_message, L, deep + 1);
                        lua_settable(L, -3);
            ...
            lua_settable(L, -3);
        }else if(true || reflection->HasField(*message, field)){
            if(field->type() == google::protobuf::FieldDescriptor::TYPE_MESSAGE){
                lua_pushstring(L, field->name().data());
                const google::protobuf::Message &field_message =reflection->GetMessage(*message, field, pbc_factory());
                pb_load_tree(&field_message, L, deep + 1);
                lua_settable(L, -3);
            }else if(field->type() == google::protobuf::FieldDescriptor::TYPE_STRING){
                lua_pushstring(L, field->name().data());
...
//将message转为lua table
static int msg_to_table(lua_State *L){
    ...
    //遍历message, 生成table
    pb_load_tree(message, L, 1);
    return 1;
}

static int msg_debug_string(lua_State *L){
...
static int msg_set_dirty(lua_State *L){
...
static int msg_merge_from(lua_State *L){
...
static int msg_repeated_merge_from(lua_State *L){
...
static int msg_copy_from(lua_State *L){
...
static int msg_msg_name(lua_State *L){
    LuaMessage *message_lua = (LuaMessage *)luaL_checkudata(L, 1, "LuaMessage");
    if(message_lua == NULL){
        LOG_ERROR("null");
        return 0;
...
static int msg_to_string(lua_State *L){
...
static int msg_get(lua_State* L){
    ...
    if(field == NULL){
        if(strcmp(field_name, "tostring") == 0){
            lua_pushcfunction(L, msg_to_string);
            return 1;
        }else if(strcmp(field_name, "msg_name") == 0){
            lua_pushcfunction(L, msg_msg_name);
            return 1;
        }else if(strcmp(field_name, "parse_from_string") == 0){
            lua_pushcfunction(L, msg_parse_from_string);
            return 1;
        }else if(strcmp(field_name, "is_dirty") == 0){
            lua_pushcfunction(L, msg_is_dirty);
            return 1;
        }else if(strcmp(field_name, "set_dirty") == 0){
            lua_pushcfunction(L, msg_set_dirty);
            return 1;
        }else if(strcmp(field_name, "copy_from") == 0){
            lua_pushcfunction(L, msg_copy_from);
            return 1;
        }else if(strcmp(field_name, "debug_string") == 0){
            lua_pushcfunction(L, msg_debug_string);
            return 1;
        }else if(strcmp(field_name, "to_table") == 0){
            lua_pushcfunction(L, msg_to_table);
            return 1;
        }else if(strcmp(field_name, "merge_from") == 0){
            lua_pushcfunction(L, msg_merge_from);
            return 1;
        }else{
    ...
    if(field->is_repeated()){
        ...
        google::protobuf::Message *message_new = reflection->MutableMessage(message, field, pbc_factory());
        if(message_new == NULL){
            LOG_ERROR("null");
            return 0;
        }
...
static int msg_set(lua_State* L){
    ...
    if(field->cpp_type() == google::protobuf::FieldDescriptor::CPPTYPE_MESSAGE && lua_isstring(L, 3)){
        ...
        google::protobuf::Message *message_field = reflection->MutableMessage(message, field, pbc_factory());
...
static int msg_delete(lua_State* L){
    LuaMessage *message_lua = (LuaMessage *)luaL_checkudata(L, 1, "LuaMessage");
    if(message_lua == NULL){
        return 0;
    }
...
static int MsgClean(lua_State* L){
...
static int GetDescriptor(lua_State* L){
    if(lua_isstring(L, 1)){
...
static int msg_repeated_iter(lua_State *L){
...
static int msg_repeated_pairs(lua_State *L){
    RepeatedField *repeated_field = (RepeatedField *)luaL_checkudata(L, 1, "RepeatedField");
    if(repeated_field == NULL){
        LOG_ERROR("null");
        return 0;
    }
    lua_pushcfunction(L, msg_repeated_iter);
    lua_pushvalue(L, -2);
    lua_pushnumber(L, 0);
    return 3;
}
static int msg_repeated_add(lua_State *L){
    RepeatedField *repeated_field = (RepeatedField *)luaL_checkudata(L, 1, "RepeatedField");
    if(repeated_field == NULL){
        LOG_ERROR("null");
        return 0;
 ...
 *
 */
static int msg_repeated_set(lua_State *L){
    RepeatedField *repeated_field = (RepeatedField *)luaL_checkudata(L, 1, "RepeatedField");
    if(repeated_field == NULL){
        LOG_ERROR("null");
        return 0;
 ...
 *
 */
static int msg_repeated_get(lua_State *L){
    RepeatedField *repeated_field = (RepeatedField *)luaL_checkudata(L, 1, "RepeatedField");
    if(repeated_field == NULL){
        LOG_ERROR("null");
        return 0;
 ...
 *
 */
static int msg_repeated_count(lua_State *L){
    RepeatedField *repeated_field = (RepeatedField *)luaL_checkudata(L, 1, "RepeatedField");
    if(repeated_field == NULL){
        LOG_ERROR("null");
        return 0;
...
static int msg_repeated_remove_last(lua_State *L){
    RepeatedField *repeated_field = (RepeatedField *)luaL_checkudata(L, 1, "RepeatedField");
    if(repeated_field == NULL){
        LOG_ERROR("null");
        return 0;
 ...
 * 删除某个元素
 */
static int msg_repeated_remove_at(lua_State *L){
    RepeatedField *repeated_field = (RepeatedField *)luaL_checkudata(L, 1, "RepeatedField");
    if(repeated_field == NULL){
        LOG_ERROR("null");
        return 0;
 ...
 */
static int msg_repeated_remove(lua_State *L){
    RepeatedField *repeated_field = (RepeatedField *)luaL_checkudata(L, 1, "RepeatedField");
    if(repeated_field == NULL){
        LOG_ERROR("null");
        return 0;
...
static int msg_repeated_clear(lua_State *L){
    RepeatedField *repeated_field = (RepeatedField *)luaL_checkudata(L, 1, "RepeatedField");
    if(repeated_field == NULL){
        LOG_ERROR("null");
        return 0;
 ...
 */
static int msg_repeated_find(lua_State *L){
    RepeatedField *repeated_field = (RepeatedField *)luaL_checkudata(L, 1, "RepeatedField");
    if(repeated_field == NULL){
        return 0;
    }
...
int pbc_init(lua_State *L)
{
    ...
    lua_pushcfunction(L, msg_repeated_pairs);
    ...
    lua_pushcfunction(L, msg_set);
    lua_settable(L, -3);
    lua_pushstring(L, "__index");
    lua_pushcfunction(L, msg_get);
    lua_settable(L, -3);
    lua_pushstring(L, "__gc");
    lua_pushcfunction(L, msg_delete);
    lua_settable(L, -3);
    ...
    lua_pushcfunction(L, msg_repeated_add);
    lua_settable(L, -3);

    lua_pushstring(L, "get");
    lua_pushcfunction(L, msg_repeated_get);
    lua_settable(L, -3);

    lua_pushstring(L, "set");
    lua_pushcfunction(L, msg_repeated_set);
    lua_settable(L, -3);

    lua_pushstring(L, "count");
    lua_pushcfunction(L, msg_repeated_count);
    lua_settable(L, -3);

    lua_pushstring(L, "remove");
    lua_pushcfunction(L, msg_repeated_remove);
    lua_settable(L, -3);

    lua_pushstring(L, "remove_at");
    lua_pushcfunction(L, msg_repeated_remove_at);
    lua_settable(L, -3);

    lua_pushstring(L, "remove_last");
    lua_pushcfunction(L, msg_repeated_remove_last);
    lua_settable(L, -3);

    lua_pushstring(L, "merge_from");
    lua_pushcfunction(L, msg_repeated_merge_from);
    lua_settable(L, -3);



    lua_pushstring(L, "clear");
    lua_pushcfunction(L, msg_repeated_clear);
    lua_settable(L, -3);

    lua_pushstring(L, "find");
    lua_pushcfunction(L, msg_repeated_find);
    lua_settable(L, -3);
