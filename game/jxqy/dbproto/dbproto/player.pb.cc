...
// source: dbproto/player.proto

#define INTERNAL_SUPPRESS_PROTOBUF_FIELD_DEPRECATION
#include "dbproto/player.pb.h"
...
void protobuf_AssignDesc_dbproto_2fplayer_2eproto() {
  protobuf_AddDesc_dbproto_2fplayer_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "dbproto/player.proto");
  GOOGLE_CHECK(file != NULL);
  PlayerData_descriptor_ = file->message_type(0);
  static const int PlayerData_offsets_[5] = {
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_dbproto_2fplayer_2eproto);
}
...
void protobuf_ShutdownFile_dbproto_2fplayer_2eproto() {
  delete PlayerData::default_instance_;
  delete PlayerData_reflection_;
}

void protobuf_AddDesc_dbproto_2fplayer_2eproto() {
  static bool already_here = false;
  if (already_here) return;
  already_here = true;
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  ::dbproto::protobuf_AddDesc_dbproto_2fuser_2eproto();
  ::dbproto::protobuf_AddDesc_dbproto_2ftask_2eproto();
  ::dbproto::protobuf_AddDesc_dbproto_2fachieve_2eproto();
  ::dbproto::protobuf_AddDesc_dbproto_2ffriend_2eproto();
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\024dbproto/player.proto\022\007dbproto\032\022dbproto"
    "/user.proto\032\022dbproto/task.proto\032\025dbproto"
    "/achieve.proto\032\024dbproto/friend.proto\"\272\001\n"
    "\nPlayerData\022\016\n\003uid\030\001 \001(\005:\0010\022#\n\010userdata\030"
    "\002 \001(\0132\021.dbproto.UserData\022#\n\010taskdata\030\003 \001"
    "(\0132\021.dbproto.TaskData\022)\n\013achievedata\030\004 \001"
    "(\0132\024.dbproto.AchieveData\022\'\n\nfrienddata\030\005"
    " \001(\0132\023.dbproto.FriendData", 305);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "dbproto/player.proto", &protobuf_RegisterTypes);
  PlayerData::default_instance_ = new PlayerData();
  PlayerData::default_instance_->InitAsDefaultInstance();
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_dbproto_2fplayer_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_dbproto_2fplayer_2eproto {
  StaticDescriptorInitializer_dbproto_2fplayer_2eproto() {
    protobuf_AddDesc_dbproto_2fplayer_2eproto();
  }
} static_descriptor_initializer_dbproto_2fplayer_2eproto_;
...
const PlayerData& PlayerData::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_dbproto_2fplayer_2eproto();
