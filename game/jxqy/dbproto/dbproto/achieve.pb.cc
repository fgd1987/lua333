...
void protobuf_AssignDesc_dbproto_2fachieve_2eproto() {
  protobuf_AddDesc_dbproto_2fachieve_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "dbproto/achieve.proto");
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_dbproto_2fachieve_2eproto);
}
...
void protobuf_ShutdownFile_dbproto_2fachieve_2eproto() {
...
void protobuf_AddDesc_dbproto_2fachieve_2eproto() {
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_dbproto_2fachieve_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_dbproto_2fachieve_2eproto {
  StaticDescriptorInitializer_dbproto_2fachieve_2eproto() {
    protobuf_AddDesc_dbproto_2fachieve_2eproto();
  }
} static_descriptor_initializer_dbproto_2fachieve_2eproto_;
...
const Achieve& Achieve::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_dbproto_2fachieve_2eproto();
