...
inline ::google::protobuf::int32 LOGIN::errno() const {
  // @@protoc_insertion_point(field_get:login.LOGIN.errno)
  return errno_;
}
inline void LOGIN::set_errno(::google::protobuf::int32 value) {
  set_has_errno();
  errno_ = value;
  // @@protoc_insertion_point(field_set:login.LOGIN.errno)
}
...
// optional int32 errno = 2 [default = 0];
inline bool ENTER::has_errno() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void ENTER::set_has_errno() {
  _has_bits_[0] |= 0x00000002u;
}
inline void ENTER::clear_has_errno() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void ENTER::clear_errno() {
  errno_ = 0;
  clear_has_errno();
}
inline ::google::protobuf::int32 ENTER::errno() const {
  // @@protoc_insertion_point(field_get:login.ENTER.errno)
  return errno_;
}
inline void ENTER::set_errno(::google::protobuf::int32 value) {
  set_has_errno();
  errno_ = value;
  // @@protoc_insertion_point(field_set:login.ENTER.errno)
}
...
// optional int32 errno = 1 [default = 0];
inline bool DISCONNECT::has_errno() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void DISCONNECT::set_has_errno() {
  _has_bits_[0] |= 0x00000001u;
}
inline void DISCONNECT::clear_has_errno() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void DISCONNECT::clear_errno() {
  errno_ = 0;
  clear_has_errno();
}
inline ::google::protobuf::int32 DISCONNECT::errno() const {
  // @@protoc_insertion_point(field_get:login.DISCONNECT.errno)
  return errno_;
}
inline void DISCONNECT::set_errno(::google::protobuf::int32 value) {
  set_has_errno();
  errno_ = value;
  // @@protoc_insertion_point(field_set:login.DISCONNECT.errno)
}
