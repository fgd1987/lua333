...
void protobuf_AssignDesc_dbproto_2ffriend_2eproto() {
  protobuf_AddDesc_dbproto_2ffriend_2eproto();
  const ::google::protobuf::FileDescriptor* file =
    ::google::protobuf::DescriptorPool::generated_pool()->FindFileByName(
      "dbproto/friend.proto");
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_dbproto_2ffriend_2eproto);
}
...
void protobuf_ShutdownFile_dbproto_2ffriend_2eproto() {
...
void protobuf_AddDesc_dbproto_2ffriend_2eproto() {
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_dbproto_2ffriend_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_dbproto_2ffriend_2eproto {
  StaticDescriptorInitializer_dbproto_2ffriend_2eproto() {
    protobuf_AddDesc_dbproto_2ffriend_2eproto();
  }
} static_descriptor_initializer_dbproto_2ffriend_2eproto_;
...
const Friend& Friend::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_dbproto_2ffriend_2eproto();
